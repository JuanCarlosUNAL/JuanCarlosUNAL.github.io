...
export type SitePageContextIntl = {
  ...
  ignoredPaths?: Maybe<Array<Maybe<Scalars['String']>>>;
};
...
export type SitePageContextIntlFilterInput = {
  ...
  ignoredPaths?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___ignoredPaths'
...
export type GetProfileImagesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProfileImagesQuery = { allImageSharp: { nodes: Array<(
      Pick<ImageSharp, 'gatsbyImageData'>
      & { fluid?: Maybe<Pick<ImageSharpFluid, 'srcSet' | 'srcSetWebp'>> }
    )> } };
...
export type GetAllPostsQuery = { allMdx: { nodes: Array<(
      Pick<Mdx, 'slug' | 'excerpt' | 'id'>
      & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'tags' | 'created'>> }
    )> } };
